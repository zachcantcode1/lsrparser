...
// Configuration file for customizing the JSON parser
// You can modify this file to change how data is fetched and parsed

const config = {
    // The URL to fetch JSON data from - Iowa State Mesonet Local Storm Reports
    apiUrl: process.env.API_URL || 'https://mesonet.agron.iastate.edu/geojson/lsr.geojson?hours=1',
    ...
    parseData: (jsonData) => {
        ...
        if (jsonData.type === 'FeatureCollection' && jsonData.features) {
            ...
            if (features.length === 0) {
                return 'No recent storm reports in the past hour.';
            }
            ...
            let displayText = `🌪️ STORM REPORTS - Last Hour\n`;
